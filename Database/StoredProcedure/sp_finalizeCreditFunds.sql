...
DROP PROCEDURE IF EXISTS sp_finalizeCreditFunds;
DELIMITER $$
CREATE PROCEDURE sp_finalizeCreditFunds
(
...
BEGIN
	...
	START TRANSACTION;
		...
		DELETE from tbl_transactioncredit where transactionid = itransactionid;

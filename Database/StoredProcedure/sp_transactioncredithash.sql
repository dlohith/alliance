...
DROP PROCEDURE IF EXISTS sp_transactioncredithash;
DELIMITER $$
CREATE PROCEDURE sp_transactioncredithash
(
...
BEGIN
	...
	START TRANSACTION;
         INSERT 
             INTO tbl_transactioncredit(transactionid, hashedvalue, updatedby, updateddate,

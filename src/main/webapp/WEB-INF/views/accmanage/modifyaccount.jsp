...
<form:form name="modify" autocomplete="off" class="form" method="POST" modelAttribute="userBackingBean" action="${pageContext.servletContext.contextPath}/auth/acc/modify">
	<div id="form">
		<table>
			<tr> <td colspan="3" align="left"><h1>Modify Account</h1></td></tr>
			<tr>
			...
			<td></td>
				<td colspan='2' align="left"><input class="submituser" name="submit" type="submit"
					...
					<input class="canceluser" type=button
						onClick="location.href='${pageContext.servletContext.contextPath}/auth/user/modify'"
						value='Cancel'/></td>
			</tr>
		</table>
	</div>
